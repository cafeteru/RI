...
public class ReflectionUtil {
	...
	private static Field getFieldInHierarchy(Class<?> clazz, String name) throws NoSuchFieldException {
		if (clazz == null) {
	...
	public static void applyValueToField(Object owner, Field field, Object value) throws IllegalArgumentException {
	...
	private static void handleMethodInvocationException(Exception exception) throws Throwable {
	...
	public static List<Field> getAnnotatedFields(Class<?> provider, Class<? extends Annotation> annotation) {
	...
	public static Method getMethodOfClass(Class<?> clazz, String methodName, Class<?>... parameterTypes) {
	...
	private static void handleExceptionForGetMethodOfClass(Class<?> clazz, String methodName, Exception ex) {

		throw new IllegalStateException("No method found for " + methodName + " in " + clazz.getSimpleName(), ex);
	}
